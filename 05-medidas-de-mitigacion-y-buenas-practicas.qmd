...
Instalar cubiertas verdes en edificaciones (@fig-techos-verdes), promoviendo la retención y absorción de agua de lluvia, además de contribuir a la regulación térmica y la mejora ambiental en entornos urbanos (Lovado, 2013).

Implementar planes de mantenimiento y dragado (@fig-dragado-canales), evitando el taponamiento y la obstrucción de canales y sistemas de drenaje (González, 2009; Lovado, 2013).
